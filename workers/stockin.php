...
<body>
    <div class="container-form">
        ...
        <form action="" method="POST">
            <h3>Import Product Here</h3>
            <hr>
            <p>
                <label for="name">Product Name</label><br>
                <input disabled type="text" name="name" value="<?php echo $ex_name?>" >
            </p>
            <p>
                <label for="">Product Price</label><br>
                <input disabled type="number" name="price" value="<?php echo $ex_price?>" >
            </p>
            <p>
    ...
    if(isset($_POST['import_product'])){
        ...
        if($execute_update){
            $query_record="INSERT into operation values(null,'in','$pid','$quantity','$date')";
